(function setUpBadge() {
    ...
    try {
        ...
        iframe.contentDocument.body.innerHTML = '<div class="badge"><div class="badge__top"><h1 class="badge__title"> Progressive Web Apps certification</h1><h2 class="badge__name"> Alexandru Păvăloi</h2></div><div class="badge__bottom is-oblique background-color--white"><p class="additional-info">Awarded by <a href="https://geekyandfun.github.io/" target="_blank">Geeky & Fun</a> for having succesfully completed our <a href="https://geekyandfun.github.io/pwa-reference" target="_blank">10 hours PWA workshop</a>.</p><a class="date"><span>04 Mar 2018</span></a><div class="keywords"><img src="https://geekyandfun.github.io/PWA-workshop/badges/icon.png" width="38"/></div></div></div>';
        iframe.contentDocument.head.innerHTML = '<link href="https://fonts.googleapis.com/css?family=Quicksand:400,700" rel="stylesheet"><link rel="stylesheet" href="https://geekyandfun.github.io/PWA-workshop/badges/pwa/pwa-style.css" />';
    } catch (e) {
